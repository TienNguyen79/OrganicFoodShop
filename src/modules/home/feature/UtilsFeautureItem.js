...
const UtilsFeautureItem = ({ data }) => {
  return (
    <div className="flex flex-col justify-center items-center py-10 after:absolute after:top-full after:content-[''] after:w-[260px] after:h-[1px] after:bg-gray-200 cursor-pointer after:hover:bg-primary after:hover:h-[2px]  ">
